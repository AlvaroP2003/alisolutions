          ...
          <Image src='/gradient.png' fill alt="bg-gradient" className="absolute inset-0 opacity-50 -z-0"/>
           ...
           <div className="flex flex-1 h-full justify-center z-20">
            ...
            <div className="flex flex-col flex-1 gap-4 text-end z-10">
                ...
                <p className="text-neutral-400 text-xs lg:text-base">I’m always excited to connect with like-minded individuals, potential collaborators, or anyone interested in bringing new ideas to life. Whether you have a project in mind, a question about my work, or just want to say hello, feel free to reach out. I’ll do my best to get back to you as soon as possible — let’s create something meaningful together!</p>
