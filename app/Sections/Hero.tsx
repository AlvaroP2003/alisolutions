...
export default function Hero() {
    ...
    return (
        <section id='home' className="relative h-[85vh] flex lg:flex-row flex-col-reverse">
            ...
            <div className="z-10 flex flex-col items-center justify-center lg:items-start text-center lg:text-start flex-1">
                ...
                <h2 className="hero-subtitle ext-xl lg:text-4xl mb-2 w-[100%] lg:w-[54%] text-neutral-200">SOFTWARE DEVELOPER.</h2> 
              <p className="hero-text text-xs lg:text-base text-neutral-400 mb-10">"Talk is cheap. Show me the code." — Linus Torvalds (Creator of Linux)</p>
                <div className="flex flex-col lg:flex-row gap-2 mb-4 w-full">
